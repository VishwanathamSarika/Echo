...
import com.example.madan.echo.CurrentSongHelper
import com.example.madan.echo.R
import com.example.madan.echo.Songs
import com.example.madan.echo.databases.EchoDatabase
import java.util.*
...
class SongPlayingFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
       ...
       Staticated.processInformation(Statified.mediaPlayer as MediaPlayer)
        ...
        if(Statified.currentSongHelper?.isPlaying is Boolean){
